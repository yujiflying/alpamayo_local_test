...
def _convert_global_enu_pose_to_t0_local_frame(
    ...
    Inputs:
        xyz_global_enu:
            [T, 3], positions in the global ENU frame.
        rot_global_enu_mats:
            [T, 3, 3], rotations in the global ENU frame.
        t0_xyz_global_enu:
            [3], t0 position in global ENU.
        t0_rot_global_enu:
            Rotation object for t0 orientation in global ENU.

    Returns:
        xyz_t0_local:
            [T, 3], positions in the raw t0-local frame.
        rot_t0_local:
            [T, 3, 3], rotations in the raw t0-local frame.
    """
...
def _convert_t0_local_rot_to_model_action_frame(
    ...
    IMPORTANT:
    - This fixed planar transform is applied to rotations only.
    - xyz stays in the raw t0-local frame for compatibility with the current
      offline pipeline and notebook expectations.
    """
