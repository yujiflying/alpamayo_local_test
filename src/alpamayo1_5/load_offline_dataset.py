...
def _load_ego_pose_log(
    ...
    # Heading is already ENU yaw: east=0, CCW positive
    yaw_deg = heading_deg
...
def get_or_build_offline_clip_cache(
    ...
    *,
    ...
    This cache stores:
    - camera file discovery
    - parsed ego pose data

    It intentionally does NOT store decoded RGB video frames.
    """
...
def load_offline_dataset(
    ...
    This version:
    - caches pose parsing
    - prefers pre-extracted image sequences if available
    - falls back to mp4 decode automatically
    """
    ...
    # Raw t0-local frame for xyz and rotations.
    ...
    return {
        ...
        "video_frame_indices": requested_video_frame_indices,  # backward-compatible
        ...
        # New time-alignment diagnostics
        ...
        # Optional coordinate-frame diagnostics for notebook clarity
